...
class _CalculateCurrencyScreenState extends State<CalculateCurrencyScreen> {
      ...
      body: ListenableBuilder(
          ...
          builder: (context, child) {
            return Column(
              ...
              children: <Widget>[
                baseCurrencyTitle(manager),
                baseCurrencyTextField(manager),
                quoteCurrencyList(manager),
              ],
            );
          }),
    );
  ...
  Padding baseCurrencyTitle(CalculateScreenManager model) {
    return Padding(
  ...
  Padding baseCurrencyTextField(CalculateScreenManager model) {
    return Padding(
  ...
  Expanded quoteCurrencyList(CalculateScreenManager model) {
    return Expanded(
